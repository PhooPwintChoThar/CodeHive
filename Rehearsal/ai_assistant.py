...
class CodeEvaluator:
    ...
    def evaluate_code(self, question:str, reference_code:str,student_code:str,  language:str, restricted_things:str=None, total_score:int=10):
            ...
            try:
                ...
                model="google/gemini-2.5-flash-lite",  # Latest Gemini 2.0 - Best free model!
                messages=[
                    {
                        "role": "system",
...
class TeacherAssistant:
    ...
    def _calculate_dynamic_max_tokens(self, question: str, question_type: str) -> int:
        """Calculate appropriate max tokens based on question complexity and type"""
    ...
    def chat(self, student_question: str, course_name: str) -> str:
        """
        Generate appropriate response based on student question and course name
        
        Args:
            student_question: The question asked by the student
            course_name: The name of the course (e.g., "Data Structures", "Algorithms")
