...
# Include Discussion API routes
app.include_router(discussion_router, prefix="/api", tags=["discussions"])
...
def startup_event():
    ...
    class_names = ['professors', 'courses', 'students', 'quizzes', 'discussions', 'chat_histories', 'comments']
...
async def show_discussions(id:int, request:Request):
    ...
    return templates.TemplateResponse("student_discussions_new.html", {"request":request, "id":id, "students": students})
