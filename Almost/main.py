...
async def show_courses(id:int,request:Request):
    ...
    return templates.TemplateResponse("teacher_courses.html", {"request":request, "id":id, "courses":courses})
...
async def show_students(id:int,cid:int,request:Request):
    ...
    return templates.TemplateResponse("teacher_course_student_list.html", {"request":request, "id":id, "course":course, "students":students_list})